...
* Project created based on the requirements for <a href="https://backend.turing.io/module3/projects/rails_engine_modified" target="_blank">Rales Engine</a>
...
* `GET /api/v1/transactions/find?credit_card_number=x` returns first transaction with credit_card_number equal to x
...
* `GET /api/v1/transactions/find_all?credit_card_number=x` returns all transactions with credit_card_number equal to x
