...
describe "Invoice Relationship Endpoints" do
  ...
  it "can return an invoice's invoice_items" do
    ...
    expect(json_response["data"][0]["attributes"]["credit_card_number"]).to eq(@invoice_item_1.credit_card_number)
  ...
  it "can return an invoice's items" do
    ...
    expect(json_response["data"][0]["attributes"]["credit_card_number"]).to eq(@tem_1.credit_card_number)
    expect(json_response["data"][0]["attributes"]["invoice_id"]).to eq(@item_1.invoice_id)
  end
  ...
  it "can return an invoice's customers" do
    ...
    expect(json_response["data"][0]["attributes"]["credit_card_number"]).to eq(@customer_1.credit_card_number)
    expect(json_response["data"][0]["attributes"]["invoice_id"]).to eq(@customer_1.invoice_id)
  end
  ...
  it "can return an invoice's merchants" do
     ...
     expect(json_response["data"][0]["attributes"]["credit_card_number"]).to eq(@merchant_1.credit_card_number)
     expect(json_response["data"][0]["attributes"]["invoice_id"]).to eq(@merchant_1.invoice_id)
  end
end
